...
A principal inovação do modelo é que a geração de conteúdo não ocorre de forma paralela, mas como uma cadeia de eventos condicionais. A geração é guiada por um contexto \textbf{externo} (topologia e progresso) e um contexto \textbf{interno} (as entidades já alocadas nos slots do próprio vértice).
